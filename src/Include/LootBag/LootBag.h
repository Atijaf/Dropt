...
namespace impl
{
	...
	template<>
	class LootBagImplementation<Variance::Interval> : public AbstractLootBag<Variance::Chance>
	{
	protected:
		bool GrabLoot(std::list<void*>& OutLoot) override { return false; };
	};
	...
	template<>
	class LootBagImplementation<Variance::Constant> : public AbstractLootBag<Variance::Chance>
	{
	protected:
		bool GrabLoot(std::list<void*>& OutLoot) override { return false; };
	};
